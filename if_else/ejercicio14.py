...
# Si es de tipo B, se rebajan 20 céntimos cuando es de tamaño 1, y 50 céntimos
# cuando es de tamaño 2.
# Realice un algoritmo para determinar la ganancia obtenida.

precio_inicial = float(input("Introduce el precio inicial por kilos de la UVA (pesos):"))
...
if tipo.upper() != "A" and tipo.upper() != "B":
    ...
    if tamano != "1" and tamano != "2":
        ...
        print("La ganancia es %.2f pesos." % (precio_final/100))